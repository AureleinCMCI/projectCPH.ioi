...
graph TB
    ...
    %% Styling
 classDef frontend fill:#000000,stroke:#ffffff,color:#ffffff,font-size:80px
    classDef backend fill:#000000,stroke:#ffffff,color:#ffffff,font-size:80px
    classDef database fill:#000000,stroke:#ffffff,color:#ffffff,font-size:80px
    classDef external fill:#000000,stroke:#ffffff,color:#ffffff,font-size:80px
    classDef client fill:#000000,stroke:#ffffff,color:#ffffff,font-size:80px
